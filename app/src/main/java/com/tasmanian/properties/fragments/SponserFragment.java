...
import com.tasmanian.properties.adapter.SponsorAdapter;
...
public class SponserFragment extends ParentFragment implements IItemHandler {
    ...
    private SponsorAdapter adapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(R.color.d_red, R.color.green,
    ...
    private void getProertyData(int requestId, int currentNo) {
        ...
        try {
            if (adapter == null) {
                adapter = new SponsorAdapter(propertUpdates, "");
                mRecyclerView.setAdapter(adapter);
            }

            String link = propertUpdates.getPropertyValue("sponsors");
        ...
        switch (requestType) {
            case 1:
                ...
                if (results != null) {
                    ...
                    Vector<Item> items = (Vector<Item>) item.get("sponsors_details");
