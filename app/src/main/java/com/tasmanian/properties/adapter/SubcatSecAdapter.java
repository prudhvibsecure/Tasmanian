...
public class SubcatSecAdapter extends RecyclerView.Adapter<SubcatSecAdapter.ContactViewHolder> {

    Vector<Item> items = new Vector<Item>();
    private Context context = null;
    public ImageLoader imageLoader;

    public SubcatSecAdapter(Context context, String domainName) {
    ...
    @Override
    public void onBindViewHolder(SubcatSecAdapter.ContactViewHolder contactViewHolder, int i) {

        Item item = items.get(i);

        contactViewHolder.template_title.setText(item.getAttribute("subcatname"));


    }

    @Override
    public SubcatSecAdapter.ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new SubcatSecAdapter.ContactViewHolder(itemView);
    }
