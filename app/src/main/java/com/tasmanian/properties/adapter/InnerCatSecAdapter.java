...
public class InnerCatSecAdapter extends RecyclerView.Adapter<InnerCatSecAdapter.ContactViewHolder> {

    Vector<Item> items = new Vector<Item>();
    private Context context = null;
    public ImageLoader imageLoader;

    public InnerCatSecAdapter(Context context, String domainName) {
    ...
    @Override
    public void onBindViewHolder(InnerCatSecAdapter.ContactViewHolder contactViewHolder, int i) {
    ...
    @Override
    public InnerCatSecAdapter.ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new InnerCatSecAdapter.ContactViewHolder(itemView);
    }
