 ...
 */
public class CategoryDetailFragment extends ParentFragment implements IItemHandler {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_title.setText(item.getAttribute("categoryname"));
//        Typeface font = Typeface.createFromAsset(getActivity().getAssets(), "fonts/Primescript.ttf");
