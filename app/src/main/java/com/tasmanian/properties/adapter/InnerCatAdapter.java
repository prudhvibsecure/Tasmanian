...
public class InnerCatAdapter extends RecyclerView.Adapter<InnerCatAdapter.ContactViewHolder> {

    Vector<Item> items = new Vector<Item>();
    private Context context = null;
    public ImageLoader imageLoader;

    public InnerCatAdapter(Context context, String domainName) {
    ...
    @Override
    public void onBindViewHolder(InnerCatAdapter.ContactViewHolder contactViewHolder, int i) {

        Item item = items.get(i);

        contactViewHolder.template_title.setText(item.getAttribute("incatname"));

        String image_path = AppSettings.getInstance(context).getPropertyValue("i_paths");

        String imageUrl = item.getAttribute("incatimage");
    ...
    @Override
    public InnerCatAdapter.ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new InnerCatAdapter.ContactViewHolder(itemView);
    }
